...
namespace IIViewDeckController
{
  ...
  //typedef void (^IIViewDeckControllerBlock) (IIViewDeckController *controller, BOOL success);
	...
	//(typeof(UIGestureRecognizerDelegate))
	interface IIViewDeckController
	{
		...
		//IntPtr PanningGestureDelegate { get; set;  }
		...
		bool ToggleRightView { get; }
		
		//- (BOOL)openRightView;
		[Export ("openRightView")]
		bool OpenRightView { get; }
		
		//- (BOOL)closeRightView;
		[Export ("closeRightView")]
		bool CloseRightView { get; }
		...
		bool ToggleTopView { get; }
		
		//- (BOOL)openTopView;
		[Export ("openTopView")]
		bool OpenTopView { get; }
		
		//- (BOOL)closeTopView;
		[Export ("closeTopView")]
		bool CloseTopView { get; }
		...
		bool ToggleBottomView { get; }
		
		//- (BOOL)openBottomView;
		[Export ("openBottomView")]
		bool OpenBottomView { get; }
		
		//- (BOOL)closeBottomView;
		[Export ("closeBottomView")]
		bool CloseBottomView { get; }
	...
	/*
	//[BaseType (typeof (UIViewDeckControllerInterface))]
	public partial class IIViewDeckController
	{
		...
		[Field ("_viewAppeared")]
		private int _viewAppeared;
		
		[Field ("_viewFirstAppeared")]
		private bool viewFirstAppeared;
		
		[Field ("_sideAppeared")]
		private int [] sideAppeared;//6
		
		[Field ("_ledge")]
		private float [] ledge;//5
		
		[Field ("_controllers")]
		private UIViewController[] controllers;//6
		...
		[Field ("_preRotationSize")]
		private SizeF preRotationSize;
		
		[Field ("_preRotationCenterSize")]
		private SizeF preRotationCenterSize;
		
		[Field ("_preRotationIsLandscape")]
		private bool preRotationIsLandscape;
		
		[Field ("_offsetOrientation")]
		private IIViewDeckOffsetOrientation offsetOrientation;
		
		[Field ("_willAppearShouldArrangeViewsAfterRotation")]
		private UIInterfaceOrientation willAppearShouldArrangeViewsAfterRotation;

		public IIViewDeckController ()
		{
...
*/
	...
	{
		//[Field ("_wrappedController")]
		//private UIViewController _wrappedController;
